 ...
 */
var person = (name: "Lindsey", age: 31)
/*: question2
 ...
 */
var someone = (name: "Scarlet", age: 5)
/*: question6
 ...
 */
let human = (name: "Steve", age: 65)
/*:
 ### 10. Can you change `human`'s age? Why or why not?
 */
// you can not change humans age because it is a constant. If it was changed to a variable we could alter the age.
